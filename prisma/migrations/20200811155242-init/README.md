# Migration `20200811155242-init`

This migration has been generated by Ahmed Elywa at 8/11/2020, 5:52:42 PM.
...
CREATE UNIQUE INDEX "Dashboard.name_unique" ON "public"."Dashboard"("name")

CREATE UNIQUE INDEX "User.email_unique" ON "public"."User"("email")

CREATE UNIQUE INDEX "Section.name_unique" ON "public"."Section"("name")

CREATE UNIQUE INDEX "Step.name_unique" ON "public"."Step"("name")

CREATE UNIQUE INDEX "Job.name_unique" ON "public"."Job"("name")

CREATE UNIQUE INDEX "Job.joid_unique" ON "public"."Job"("joid")
